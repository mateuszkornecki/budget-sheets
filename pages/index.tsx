...
import { ExpenseCategories, Expense, getAllExpenses, postExpense, getFilteredExpenses } from '../api/expenses';
...
function Home() {
  ...
  const content = isLoading ? <p>Loading...</p> : data.map(
    expense => <p>{expense.createdAt}</p>);
